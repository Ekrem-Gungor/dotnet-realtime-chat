using RealtimeChat.Application.Mapping;
...
using RealtimeChat.Infrastructure.Services.RedisServices;
...
namespace RealtimeChat.DependencyInjection.CustomServiceInjections
{
    public static class CustomServiceInjection
    {
        public static void AddCustomIdentityServices(this IServiceCollection services)
        {
            ...
            }).AddEntityFrameworkStores<RealtimeChatDbContext>().AddDefaultTokenProviders();
        }
