...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.Concretes.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.Concretes.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.Concretes.AppUserProfile", b =>
                {
                    b.Property<int>("ID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.Concretes.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.Concretes.ChatMessage", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.Concretes.AppUserProfile", b =>
                {
                    b.HasOne("RealtimeChat.Domain.Entities.Concretes.AppUser", "AppUser")
                        .WithOne("Profile")
                        .HasForeignKey("RealtimeChat.Domain.Entities.Concretes.AppUserProfile", "ID")
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.Concretes.AppUserRole", b =>
                {
                    b.HasOne("RealtimeChat.Domain.Entities.Concretes.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RealtimeChat.Domain.Entities.Concretes.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.Concretes.ChatMessage", b =>
                {
                    b.HasOne("RealtimeChat.Domain.Entities.Concretes.AppUser", "Sender")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("RealtimeChat.Domain.Entities.Concretes.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("RealtimeChat.Domain.Entities.Concretes.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
